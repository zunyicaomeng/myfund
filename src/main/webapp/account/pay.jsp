...
<div id="content">
    ...
    <div id="pay_part">
    <div id="part_p">
    	<p class="case">充值金额：<input type="number" name="" style="width: 250px;height: 35px;border-radius: 5px;padding: 0 0 0 5px;" placeholder="请输入充值金额："></p>
    	<p class="case">交易密码：<input type="password" name="" style="width: 250px;height: 35px;border-radius: 5px;padding: 0 0 0 5px;" placeholder="请输入交易密码："></p>
    	<p class="case">快捷支付</p>
    	<p id="case_p"></p>
    	<div id="part_t">
    		<p class="case"><img src="/My-Fund/images/E-bank.jpg" id="E-bank"></p>
