...
<div id="background">
    ...
    <div id="content">
        ...
        <div id="logn_form">
            <div id="logn_form_fl">
                <div id="logn_form_logo">
                    <img src="images/timg.png" style="margin-left: 20%">
                </div>
            </div>
            <div id="logn_form_fr">
                <form action="getLoginUser" method="post" id="login_form">
                    ...
                    <div id="input_btn_login">
                        <input type="submit" value="登录" id="btn_login" class="btn" onclick="return login()">
                    </div>
                </form>
            </div>
        </div>
