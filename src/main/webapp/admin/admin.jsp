        ...
        <div id="loginDemo">
            ...
            <p class="admin_p">三丶管理员可以修改登陆用户的用户名和密码、禁用用户登陆、删除登陆用户</p>
							...
							<form method="post" action="">
								<div id="account-div">
									<button type="button" id="account-Demo2"
										style="border-color: black" onclick="MondifyUser();">
										<B>修改用户</B>
									</button>
									<button type="button" id="account-Demo3"
										style="border-color: black" onclick="UserDelete();">
										<B>删除用户</B>
									</button>

									<button type="button" id="account-Demo1"
										style="border-color: black" onclick="FreezeUser();">
										<B>冻结用户</B>
									</button>
								</div>
							</form>
